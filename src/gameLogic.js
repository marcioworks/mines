...
const safeNieghborhood = (board, row,column) =>{
...
const openField =(board, row,column) =>{
  ...
  if(!field.opened){
    ...
    if(field.mined){
      field.exploded = true
    }else if(safeNieghborhood(board,row,column)){
...
const pendding = field => (field.mined && !field.flaged) ||(!field.mined && !field.opened)
